                    ...
                    <div class="row">
                                    ...
                                    <div id="gallery" class="product-dec-slider-2 product-tab-left">
                                        @if ($get_slug->image)
                                            <a data-image="{{ asset('storage/' . $get_slug->image) }}"
                                                ...
                                                class="slick-slide" data-slick-index="0" aria-hidden="false" tabindex="0">
                                ...
                                <div class="zoompro-wrap product-zoom-right pl-20">
                                    <div class="zoompro-span">
                                        <img class="zoompro blur-up lazyload"
                                            data-zoom-image="{{ asset('storage/' . $get_slug->image) }}" alt=""
                                            src="{{ asset('storage/' . $get_slug->image) }}" />
                                    </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="product-single__meta">
                                ...
                                <div class="prInfoRow">
                                    <div class="product-stock"> @if ($get_slug->stock_status == 'In Stock')
                                        <span class="instock " style="color: #447900">{{ $get_slug->stock_status }}</span>
                                    ...
                                    @endif </div>
                                    <div class="product-sku">SKU: <span class="variant-sku">{{ $get_slug->sku }}</span></div>
                                    <div class="product-review"><a class="reviewLink" href="#tab2"><i
                                                ...
                                                class="font-13 fa fa-star-o"></i><span class="spr-badge-caption">{{ $get_slug->rating_count }}
                                                reviews</span></a></div>
                                </div>
                                        ...
                                        <div class="spr-reviews">
                                            ...
                                            <div class="spr-review">
                                                <div class="spr-review-header">
                                                    ...
                                                    <span class="spr-review-header-byline"><strong>larrydude</strong>
                                            ...
                                            <div class="spr-review">
                                                <div class="spr-review-header">
                                                    ...
                                                    <h3 class="spr-review-header-title">Neque porro quisquam est qui
                                                        ...
                                                        velit...</h3>
                                                    <span class="spr-review-header-byline"><strong>quoctri1905</strong>
                                                        on <strong>Dec 30, 2018</strong></span>
                                                </div>
