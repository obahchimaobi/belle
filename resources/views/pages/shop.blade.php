        ...
        <div class="collection-header">
            <div class="collection-hero">
                <div class="collection-hero__image"><img class="blur-up lazyload"
                        data-src="{{ asset('assets/images/cat-women.jpg') }}" src="{{ asset('assets/images/cat-women.jpg') }}"
                        ...
                        <div class="sidebar_widget categories filter-widget">
                            ...
                            <div class="widget-content">
                                <ul class="sidebar_categories">
                                    <li class="level1 sub-level"><a href="{{ asset('#;') }}" class="site-nav">Clothing</a>
                                        <ul class="sublinks">
                                            <li class="level2"><a href="{{ asset('#;') }}" class="site-nav">Men</a></li>
                                            <li class="level2"><a href="{{ asset('#;') }}" class="site-nav">Women</a></li>
                                            <li class="level2"><a href="{{ asset('#;') }}" class="site-nav">Child</a></li>
                                            <li class="level2"><a href="{{ asset('#;') }}" class="site-nav">View All
                                                    Clothing</a></li>
                                        </ul>
                                    </li>
                                    <li class="level1 sub-level"><a href="{{ asset('#;') }}"
                                            class="site-nav">Jewellery</a>
                                        <ul class="sublinks">
                                            <li class="level2"><a href="{{ asset('#;') }}" class="site-nav">Ring</a></li>
                                            <li class="level2"><a href="{{ asset('#;') }}" class="site-nav">Neckalses</a>
                                            </li>
                                            <li class="level2"><a href="{{ asset('#;') }}" class="site-nav">Eaarings</a>
                                            </li>
                                            <li class="level2"><a href="{{ asset('#;') }}" class="site-nav">View All
                                                    Jewellery</a></li>
                                        </ul>
                                    </li>
                                    <li class="lvl-1"><a href="{{ asset('#;') }}" class="site-nav">Shoes</a>
                                    </li>
                                    <li class="lvl-1"><a href="{{ asset('#;') }}" class="site-nav">Accessories</a></li>
                                    <li class="lvl-1"><a href="{{ asset('#;') }}" class="site-nav">Collections</a></li>
                                    <li class="lvl-1"><a href="{{ asset('#;') }}" class="site-nav">Sale</a>
                                    </li>
                                    <li class="lvl-1"><a href="{{ asset('#;') }}" class="site-nav">Page</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                    ...
                                    <div class="grid">
                                        <div class="grid__item">
                                            <div class="mini-list-item">
                                                <div class="mini-view_image">
                                                    <a class="grid-view-item__link" href="{{ asset('#') }}">
                                                        <img class="grid-view-item__image"
                                                            src="{{ asset('assets/images/product-images/mini-product-img.jpg') }}"
                                                            alt="" />
                                                    </a>
                                                </div>
                                                <div class="details"> <a class="grid-view-item__title"
                                                        href="{{ asset('#') }}">Cena Skirt</a>
                                        ...
                                        <div class="grid__item">
                                            <div class="mini-list-item">
                                                <div class="mini-view_image"> <a class="grid-view-item__link"
                                                        href="{{ asset('#') }}"><img class="grid-view-item__image"
                                                            src="{{ asset('assets/images/product-images/mini-product-img1.jpg') }}"
                                                            alt="" /></a> </div>
                                                <div class="details"> <a class="grid-view-item__title"
                                                        href="{{ asset('#') }}">Block Button Up</a>
                                                    <div class="grid-view-item__meta"><span
                                                            class="product-price__price"><span
                                        ...
                                        <div class="grid__item">
                                            <div class="mini-list-item">
                                                <div class="mini-view_image"> <a class="grid-view-item__link"
                                                        href="{{ asset('#') }}"><img class="grid-view-item__image"
                                                            src="{{ asset('assets/images/product-images/mini-product-img2.jpg') }}"
                                                            alt="" /></a> </div>
                                                <div class="details"> <a class="grid-view-item__title"
                                                        href="{{ asset('#') }}">Balda Button Pant</a>
                                                    <div class="grid-view-item__meta"><span
                                                            class="product-price__price"><span
                                        ...
                                        <div class="grid__item">
                                            <div class="mini-list-item">
                                                <div class="mini-view_image"> <a class="grid-view-item__link"
                                                        href="{{ asset('#') }}"><img class="grid-view-item__image"
                                                            src="{{ asset('assets/images/product-images/mini-product-img3.jpg') }}"
                                                            alt="" /></a> </div>
                                                <div class="details"> <a class="grid-view-item__title"
                                                        href="{{ asset('#') }}">Border Dress in
                                                        Black/Silver</a>
                                                    <div class="grid-view-item__meta"><span
                                                            class="product-price__price"><span
                        ...
                        <div class="sidebar_widget">
                            ...
                            <div class="widget-content">
                                <ul class="product-tags">
                                    <li><a href="{{ asset('#') }}" title="Show products matching tag $100 - $400">$100
                                            - $400</a></li>
                                    <li><a href="{{ asset('#') }}" title="Show products matching tag $400 - $600">$400
                                            - $600</a></li>
                                    <li><a href="{{ asset('#') }}" title="Show products matching tag $600 - $800">$600
                                            - $800</a></li>
                                    <li><a href="{{ asset('#') }}" title="Show products matching tag Above $800">Above
                                            $800</a></li>
                                    <li><a href="{{ asset('#') }}" title="Show products matching tag Allen Vela">Allen
                                            Vela</a></li>
                                    <li><a href="{{ asset('#') }}" title="Show products matching tag Black">Black</a>
                                    </li>
                                    <li><a href="{{ asset('#') }}" title="Show products matching tag Blue">Blue</a>
                                    </li>
                                    <li><a href="{{ asset('#') }}"
                                            title="Show products matching tag Cantitate">Cantitate</a></li>
                                    <li><a href="{{ asset('#') }}"
                                            title="Show products matching tag Famiza">Famiza</a></li>
                                    <li><a href="{{ asset('#') }}" title="Show products matching tag Gray">Gray</a>
                                    </li>
                                    <li><a href="{{ asset('#') }}" title="Show products matching tag Green">Green</a>
                                    </li>
                                    <li><a href="{{ asset('#') }}" title="Show products matching tag Hot">Hot</a></li>
                                    <li><a href="{{ asset('#') }}" title="Show products matching tag jean shop">jean
                                            shop</a></li>
                                    <li><a href="{{ asset('#') }}" title="Show products matching tag jesse kamm">jesse
                                            kamm</a></li>
                                    <li><a href="{{ asset('#') }}" title="Show products matching tag L">L</a></li>
                                    <li><a href="{{ asset('#') }}"
                                    ...
                                    <li><a href="{{ asset('#') }}" title="Show products matching tag M">M</a></li>
                                    <li><a href="{{ asset('#') }}"
                                            title="Show products matching tag mini-dress">mini-dress</a></li>
                                    <li><a href="{{ asset('#') }}"
                                            title="Show products matching tag Monark">Monark</a></li>
                                    <li><a href="{{ asset('#') }}" title="Show products matching tag Navy">Navy</a>
                                    </li>
                                    <li><a href="{{ asset('#') }}" title="Show products matching tag new">new</a></li>
                                    <li><a href="{{ asset('#') }}" title="Show products matching tag new arrivals">new
                                            arrivals</a></li>
                                    <li><a href="{{ asset('#') }}"
                ...
                <div class="col-12 col-sm-12 col-md-9 col-lg-9 main-col">
                            ...
                            <div class="filters-toolbar-wrapper">
                                <div class="row">
                                    <div
                                        ...
                                        <a href="{{ asset('shop-left-sidebar.html') }}" title="Grid View"
                                            class="change-view change-view--active">
                                            <img src="{{ asset('assets/images/grid.jpg') }}" alt="Grid" />
                                        </a>
                                        <a href="{{ asset('shop-listview.html') }}" title="List View"
                                            class="change-view">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-details text-center">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="{{ asset('#') }}">Elastic Waist Dress</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-details text-center">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="{{ asset('#') }}">3/4 Sleeve Kimono Dress</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="{{ asset('#') }}">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image17.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image17.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image17-1.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image17-1.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End hover image -->
                                            <!-- product label -->
                                            <div class="product-labels"><span class="lbl on-sale">Sale</span>
                                    ...
                                    <div class="product-details text-center">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="{{ asset('#') }}">Buttercup Dress</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="{{ asset('#') }}">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image18.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image18.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image18-1.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image18-1.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                    ...
                                    <div class="product-details text-center">
                                        ...
                                        <ul class="swatches">
                                            <li class="swatch medium rounded"><img
                                                    src="{{ asset('assets/images/product-images/variant5-1.jpg') }}"
                                                    alt="image" /></li>
                                            <li class="swatch medium rounded"><img
                                                    src="{{ asset('assets/images/product-images/variant5-1.jpg') }}"
                                                    alt="image" /></li>
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="{{ asset('#') }}">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image19.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image19.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image19-1.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image19-1.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="{{ asset('#') }}">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image20.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image20.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image20-1.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image20-1.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End hover image -->
                                            <!-- product label -->
                                    ...
                                    <div class="product-details text-center">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="{{ asset('#') }}">Floral Sleeveless Dress</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="{{ asset('#') }}">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image21.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image21.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image21-1.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image21-1.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                    ...
                                    <div class="product-details text-center">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="{{ asset('#') }}">Button Up Dress</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="{{ asset('#') }}">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image22.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image22.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image22-1.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image22-1.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="{{ asset('#') }}">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image23.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image23.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image23-1.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image23-1.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                    ...
                                    <div class="product-details text-center">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="{{ asset('#') }}">One Shoulder Dress in Navy</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="{{ asset('#') }}">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image24.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image24.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image24-1.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image24-1.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                    ...
                                    <div class="product-details text-center">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="{{ asset('#') }}">Triangle Sleeveless Dress in Multi</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="{{ asset('#') }}">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image25.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image25.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image25-1.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image25-1.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="{{ asset('#') }}">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image26.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image26.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image26-1.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image26-1.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item grid-view-item--sold-out">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="{{ asset('#') }}">
                                            ...
                                            <img class="grid-view-item__image primary blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image27.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image27.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="grid-view-item__image hover blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image27-1.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image27-1.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End hover image -->
                                    ...
                                    <div class="product-details text-center">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="{{ asset('#') }}">Camelia Reversible Jacket in
                                                Navy/Blue</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="{{ asset('#') }}">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image28.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image28.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image28-1.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image28-1.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                    ...
                                    <div class="product-details text-center">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="{{ asset('#') }}">Wrinkled Tux Shirt in Navy</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="{{ asset('#') }}">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image29.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image29.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image29-1.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image29-1.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                    ...
                                    <div class="product-details text-center">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="{{ asset('#') }}">A-Line Mini Dress in Blue</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="{{ asset('#') }}">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image30.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image30.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image30-1.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image30-1.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                        ...
                                        <div class="button-set">
                                            <a href="{{ asset('#content_quickview') }}" title="Quick View"
                                    ...
                                    <div class="product-details text-center">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="{{ asset('#') }}">Asymmetric Dress in Black</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="{{ asset('#') }}">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image31.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image31.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-images/product-image31-1.jpg') }}"
                                                src="{{ asset('assets/images/product-images/product-image31-1.jpg') }}"
                                                alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                    ...
                                    <div class="product-details text-center">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="{{ asset('#') }}">Babydoll Bow Dress</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                    ...
                    <div class="infinitpaginOuter">
                        <div class="infinitpagin">
                            <a href="{{ asset('#') }}" class="btn loadMore">Load More</a>
                        </div>
                    </div>
                </div>
                <!--End Main Content-->
                                    ...
                                    <div class="product-details-img">
                                        <div class="pl-20">
                                            <img class="blur-up lazyload"
                                                data-src="{{ asset('assets/images/product-detail-page/camelia-reversible-big1.jpg') }}"
                                                src="{{ asset('assets/images/product-detail-page/camelia-reversible-big1.jpg') }}"
                                                alt="" />
                                        </div>
                                    </div>
                                </div>
