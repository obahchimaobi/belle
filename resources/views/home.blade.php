                                    ...
                                    <div class="productSlider">
                                                ...
                                                <div class="button-set">
                                                    ...
                                                    <div class="wishlist-btn">
                                                        <a class="wishlist add-to-wishlist"
                                                            href="{{ asset('wishlist.html') }}">
                                                            <i class="icon anm anm-heart-l"></i>
                                                        </a>
                                                    </div>
                                                    <div class="compare-btn">
                                                        <a class="compare add-to-compare"
                                                            href="{{ asset('compare.html') }}" title="Add to Compare">
                                        ...
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="{{ asset('short-description.html') }}">Elastic Waist
                                                        Dress</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                        ...
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="{{ asset('short-description.html') }}">3/4 Sleeve
                                                        Kimono Dress</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                        ...
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="{{ asset('short-description.html') }}">Cape
                                                        Dress</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                        ...
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="{{ asset('short-description.html') }}">Paper
                                                        Dress</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                    ...
                                    <div class="productSlider">
                                        ...
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="{{ asset('short-description.html') }}">Workers
                                                        Shirt Jacket</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                        ...
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="{{ asset('short-description.html') }}">Watercolor
                                                        Sport Jacket in Brown/Blue</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                                <div class="product-price">
                                        ...
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="{{ asset('short-description.html') }}">Washed Wool
                                                        Blazer</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                    ...
                                    <div class="productSlider">
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="{{ asset('short-description.html') }}">Azur
                                                        Bracelet in Blue Azurite</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                                <div class="product-price">
                                        ...
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="{{ asset('short-description.html') }}">
                                                    ...
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload"
                                                        data-src="{{ asset('assets/images/product-images/product-image12-1.jpg') }}"
                                                        src="{{ asset('assets/images/product-images/product-image12-1.jpg') }}"
                                                        alt="image" title="product">
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="{{ asset('short-description.html') }}">Bi-Goutte
                                                        Earrings</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                        ...
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="{{ asset('short-description.html') }}">Ashton
                                                        Necklace</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                        ...
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="{{ asset('short-description.html') }}">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload"
                                                        data-src="{{ asset('assets/images/product-images/product-image14.jpg') }}"
                                                        src="{{ asset('assets/images/product-images/product-image14.jpg') }}"
                                                        alt="image" title="product">
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload"
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="{{ asset('short-description.html') }}">Ara Ring</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                                <div class="product-price">
