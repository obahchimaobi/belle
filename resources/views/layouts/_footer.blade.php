                ...
                <div
                    ...
                    <div class="footer-social">
                        <ul class="list--inline site-footer__social-icons social-icons">
                            <li><a class="social-icons__link" href="{{ asset('#') }}" target="_blank"
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-3 col-lg-3 footer-links">
                        ...
                        <ul>
                            ...
                            <li><a href="{{ asset('#') }}">Sportswear</a></li>
                    ...
                    <div class="col-12 col-sm-12 col-md-3 col-lg-3 footer-links">
                        ...
                        <ul>
                            ...
                            <li><a href="{{ asset('#') }}">Careers</a></li>
                            <li><a href="{{ asset('#') }}">Privacy policy</a></li>
                            <li><a href="{{ asset('#') }}">Terms &amp; condition</a></li>
                            <li><a href="{{ asset('#') }}">My Account</a></li>
                        </ul>
                    </div>
                    <div class="col-12 col-sm-12 col-md-3 col-lg-3 footer-links">
                        <h4 class="h4">Customer Services</h4>
                        <ul>
                            <li><a href="{{ asset('#') }}">Request Personal Data</a></li>
                            <li><a href="{{ asset('#') }}">FAQ's</a></li>
                            <li><a href="{{ asset('#') }}">Contact Us</a></li>
                            <li><a href="{{ asset('#') }}">Orders and Returns</a></li>
                            <li><a href="{{ asset('#') }}">Support Center</a></li>
                        </ul>
                    </div>
            ...
            <div class="footer-bottom">
                <div class="row">
                    ...
                    <div
                        ...
                        <span></span> <a href="{{ asset('templateshub.net') }}">Templates Hub</a></div>
